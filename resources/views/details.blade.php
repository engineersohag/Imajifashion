      ...
      <div class="row">
              ...
              <div class="swiper-container">
                <div class="swiper-wrapper">
                  ...
                  <div class="swiper-slide product-single__image-item">
                    ...
                    <a data-fancybox="gallery" target="_blank" href="{{asset('uploads/products')}}/{{$product->image}}" data-bs-toggle="tooltip" data-bs-placement="left" title="Zoom">
        ...
        <div class="col-lg-5">
          ...
          <div class="product-single__addtolinks">
            ...
            <form id="frm-remove-id" method="POST" action="{{route('wishlist.item.remove', ['rowId'=>Cart::instance('wishlist')->content()->where('id', $product->id)->first()->rowId])}}">
              @csrf 
              @method('DELETE')
              <a onclick="document.getElementById('frm-remove-id').submit();" href="javascript:void(0)" class="menu-link menu-link_us-s remove-form-wishlist filled-heart"><svg width="16" height="16" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <use href="#icon_heart" />
