    ...
    <section class="shop-checkout container">
      ...
      <div class="order-complete">
        ...
        <div class="order-info" id="order-info">
          ...
          <div class="">
            <a href="javascript:void(0)" onclick="printOrderSection()" class="btn shadow-lg text-secondary p-0">
...
@push('scripts')
<script>
    document.getElementById('order-info').style.display = 'flex';
    function printOrderSection() {
        window.print();
    }
</script>
@endpush
