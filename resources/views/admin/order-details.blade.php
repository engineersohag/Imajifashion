            ...
            <div class="table-responsive">
                ...
                <table class="table table-striped table-bordered">
                    ...
                    <tr>
                        ...
                        <td>
                            {{ $order->delivered_date ? \Carbon\Carbon::parse($order->delivered_date)->format('M d, Y') : 'Not delivered' }}
                        </td>
                        <th>Canceled Date</th>
                        <td>
                            {{ $order->canceled_date ? \Carbon\Carbon::parse($order->canceled_date)->format('M d, Y') : 'Not Cancel Order' }}
                        </td>
                    </tr>
                    <tr>
                        <th>Order Status</th>
        ...
        <div class="wg-box mt-5">
            ...
            <form action="{{route('admin.order.status.update')}}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <button class="btn btn-primary tf-button w208" type="submit">Update Status</button>
                    </div>
                </div>
            </form>
